...
class RootRouter extends _i5.RootStackRouter {
  ...
  final Map<String, _i5.PageFactory> pagesMap = {
    AccountHomeRoute.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(
          routeData: routeData, child: _i1.AccountHomePage());
    },
    AccountFormRoute.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(
          routeData: routeData, child: _i2.AccountFormPage());
    },
  ...
  List<_i5.RouteConfig> get routes => [
        _i5.RouteConfig(AccountHomeRoute.name, path: '/'),
...
/// generated route for
/// [_i1.AccountHomePage]
class AccountHomeRoute extends _i5.PageRouteInfo<void> {
